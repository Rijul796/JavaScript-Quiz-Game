...
const quizArray = [
  ...
  },
  {
    ...
    options: ["Dave Raggett", "Tim Berners-Lee", "Denis Ritchie", "none"],
  ...
  },
  {
    ...
    options: ["To define title text", "To define reference of a document", "To define destination URL", "None"],
    correct: "To define destination URL",
  },
  {
    id: "9",
...
nextBtn.addEventListener(
  ...
  (displayNext = () => {
    ...
    if (questionCount == quizArray.length) {
      ...
      //user score
      userScore.innerHTML =
        "You have scored " + scoreCount + " out of " + questionCount;
    } else {
